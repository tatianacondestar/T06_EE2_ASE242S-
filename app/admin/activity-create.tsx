...
export default function ActivityCreate() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Actividad creada', 'La actividad fue guardada correctamente.', [
        { text: 'OK', onPress: () => router.back() },
      ]);
    } catch {
      Alert.alert('Error', 'No se pudo crear la actividad. Verifica la conexión al servidor.');
    }
  };
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={styles.largeTitle}>Nueva Actividad</Text>
